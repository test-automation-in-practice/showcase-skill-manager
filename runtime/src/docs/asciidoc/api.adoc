...
Please take a look at the _employees_, _projects_ and _skills_ API documentation files for a detailed description of each of the available resources for those domains.
