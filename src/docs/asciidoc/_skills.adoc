...
include::{snippets}/skills/find/multiple/http-request.adoc[]
include::{snippets}/skills/find/multiple/http-response.adoc[]

In case there are no skills to be found, the response will look like this:

include::{snippets}/skills/find/empty/http-response.adoc[]

Existing skills can also be searched using the `query` parameter:

include::{snippets}/skills/find/with-query/http-request.adoc[]
include::{snippets}/skills/find/with-query/http-response.adoc[]
