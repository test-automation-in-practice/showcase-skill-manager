...
@UnitTest
internal class StringToProjectAssignmentIdConverterTests {

    private val cut = StringToProjectAssignmentIdConverter()
    ...
    fun `coverts valid values`(uuid: String) {
        assertThat(cut.convert(uuid)).isEqualTo(projectAssignmentId(uuid))
    }
