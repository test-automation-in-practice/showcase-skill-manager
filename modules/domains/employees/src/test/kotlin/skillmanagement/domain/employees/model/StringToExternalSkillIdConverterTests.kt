...
@UnitTest
internal class StringToExternalSkillIdConverterTests {

    private val cut = StringToExternalSkillIdConverter()
    ...
    fun `coverts valid values`(uuid: String) {
        assertThat(cut.convert(uuid)).isEqualTo(skillId(uuid))
    }
