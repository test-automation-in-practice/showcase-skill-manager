...
@WebMvcTest(GetSkillsHttpAdapter::class)
...
internal class GetSkillsHttpAdapterTests(
    ...
    fun `responds with 200 Ok and empty list if there are no Skills`() {
        ...
        verify { getSkills(AllSkillsQuery(pageIndex = PageIndex.DEFAULT, pageSize = PageSize.DEFAULT)) }
    }
    ...
    fun `responds with 200 Ok and Skills on requested page`() {
        ...
        verify { getSkills(AllSkillsQuery(pageIndex = PageIndex(1), pageSize = PageSize(1))) }
    }
    ...
    fun `paging data is handed over correctly`() {
        ...
        verify { getSkills(AllSkillsQuery(pageIndex = PageIndex(2), pageSize = PageSize(42))) }
    }
