...
@WebMvcTest(GetSkillByIdRestAdapter::class)
@Import(GetSkillByIdRestAdapterTestsConfiguration::class)
@AutoConfigureRestDocs("build/generated-snippets/skills/get-by-id", uriPort = 80)
internal class GetSkillByIdRestAdapterTests(
...
private class GetSkillByIdRestAdapterTestsConfiguration {
    @Bean
